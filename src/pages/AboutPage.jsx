...
function AboutPage() {
  return (
    <div className="flex flex-col items-center justify-center font-light md:pt-3 pb-10 md:px-20">
      <h1 className="text-3xl text-center font-bold mt-5 animate-fade-down animate-once animate-ease-linear">
        Welcome to our Task Manager!
      </h1>
      <div className="md:flex justify-center  ">
        <div className="flex flex-col items-center gap-5 mt-12 md:flex-1 animate-fade-right animate-once animate-ease-linear">
        ...
        <div className="flex flex-col items-center gap-5 mt-10 md:flex-1 animate-fade-left animate-once animate-ease-linear">
