...
function AboutPage() {
  return (
    <div className="flex flex-col items-center justify-center font-light pt-3 pb-10 md:px-20">
      ...
      <div className="md:flex justify-center">
        <div className="flex flex-col items-center gap-5 mt-12 md:flex-1">
          <img src={tasks} alt="tasks" className="h-auto max-h-[400px]" />
        ...
        <div className="flex flex-col items-center gap-5 mt-10 md:flex-1">
          <img src={addtask} alt="addtask" className="h-auto max-h-[400px]" />
          <p className="text-justify mb-2 md:text-2xl sm:text-xl md:px-10">
